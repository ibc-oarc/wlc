...
verses:
  ...
  - "4.9": |
      обе почки с жиром, который на них и который возле бедер, и сальник с печени, все это он вынет вместе с почками —
  - "4.10": |
      как удаляют жир из вола,<span class="notespan"><span class="marginnote note" label="note-5"> Или: «из коровы».        </span></span> которого приносят в жертву примирения. Пусть священник сожжет это на жертвеннике для всесожжений.
  - "4.11": |
  ...
  - "6.13": |
      — Вот приношение, которое Аарон и его сыновья должны приносить Господу в день, когда они принимают помазание: десятая часть ефы<span class="notespan"><span class="marginnote note" label="note-8"> Возможно, около 2 л.</span></span> лучшей муки как постоянное хлебное приношение — половину утром и половину вечером.
  - "6.14": |
  ...
  - "17.3": |
      всякий израильтянин, приносящий в жертву вола,<span class="notespan"><span class="marginnote note" label="note-30"> Это еврейское слово может обозначать как самца, так и самку.        </span></span> ягненка или козленка в лагере или вне его
  - "17.4": |
  ...
  - "18.6": |
      Пусть никто не приближается ни к какой из близких родственниц, чтобы иметь с ней половые отношения.<span class="notespan"><span class="marginnote note" label="note-31"> Букв.: «чтобы открыть наготу». Также в других местах этой книги.</span></span> Я — Господь.
  - "18.7": |
  ...
  - "18.17": |
      Не вступай в половые отношения с матерью и дочерью. Не совокупляйся с дочерью ее сына или дочери: они <em>твои</em> близкие родственники. Это разврат.
  - "18.18": |
  ...
  - "18.21": |
      Не отдавай своих детей в жертву<span class="notespan"><span class="marginnote note" label="note-32"> Букв.: «чтобы перевести их».</span></span> Молоху,<span class="notespan"><span class="marginnote note" label="note-33"> Молох — аммонитский бог. Существует два толкования этого стиха: 1) отдавать в жертву, проводя через огонь (см. <span class="link">4Цар 21:6</span>; <span class="link">4Цар 23:10</span>); 2) отдавать в храм Молоха для занятия культовой проституцией. См. также 20:2−5.        </span></span> не бесчести имени своего Бога. Я — Господь.
  - "18.22": |
  ...
  - "19.23": |
      Когда вы придете в эту страну и посадите фруктовые деревья, считайте их плоды недозволенными.<span class="notespan"><span class="marginnote note" label="note-34"> Букв.: «необрезанными».</span></span> В течение трех лет считайте их недозволенными<span class="notespan"><span class="marginnote note" label="note-35"> Букв.: «необрезанными».</span></span> и не ешьте.
  - "19.24": |
  ...
  - "19.28": |
      Не делайте порезов на теле, когда оплакиваете умерших и не делайте на себе татуировок.<span class="notespan"><span class="marginnote note" label="note-36"> Эти стихи описывают языческие ритуалы скорби, которым израильтяне не должны были следовать.</span></span>  Я — Господь.
  - "19.29": |
      Не оскверняйте своих дочерей, делая из них храмовых блудниц,<span class="notespan"><span class="marginnote note" label="note-37"> Храмовые блудницы — имеются в виду «жрицы любви», которые были неотъемлемой частью весьма распространенных в те дни языческих культов плодородия.</span></span> иначе земля наполнится развратом и растлением.
  - "19.30": |
  ...
  - "19.32": |
      Вставайте перед старцем,<span class="notespan"><span class="marginnote note" label="note-38"> Букв.: «перед седым».</span></span> выказывайте уважение к престарелым и чтите вашего Бога. Я — Господь.
  - "19.33": |
  ...
  - "19.36": |
      Пользуйтесь точными весами и верными гирями, верной ефой<span class="notespan"><span class="marginnote note" label="note-39"> Мера веса.</span></span> и верным гином.<span class="notespan"><span class="marginnote note" label="note-40"> Мера объема.        </span></span>  Я — Господь, ваш Бог, Который вывел вас из Египта.
  - "19.37": |
  ...
  - "20.11": |
      Если мужчина переспит с женой отца<span class="notespan"><span class="marginnote note" label="note-41"> Имеется в виду не мать данного человека, а другая жена его отца.        </span></span> — он опозорил отца. И мужчину, и женщину нужно предать смерти — они сами виновны в своей гибели.
  - "20.12": |
  ...
  - "21.4": |
      Но пусть он не оскверняет себя ради тех, кто породнился с ним через брак.<span class="notespan"><span class="marginnote note" label="note-42"> Или: «Но пусть он не оскверняет себя, так как он лидер своего народа». Смысл этого места в еврейском тексте неясен.        </span></span>
  - "21.5": |
  ...
  - "21.18": |
      Никому с телесным изъяном: ни слепому, ни хромому, ни уродливому, ни калеке нельзя приближаться <em>ко Мне</em>,
  - "21.19": |
  ...
  - "22.23": |
      Вы можете приносить в добровольное пожертвование вола<span class="notespan"><span class="marginnote note" label="note-43"> Это еврейское слово может обозначать как самца, так и самку.        </span></span> или ягненка, у которых чересчур длинные или короткие члены тела, но для исполнения обета они не пригодны.
  - "22.24": |
      Не приносите Господу животное, <em>яички которого</em> повреждены, раздавлены, вырваны или отрезаны. Не делайте этого на вашей земле,
  - "22.25": |
  ...
  - "23.9": |
      Господь сказал Моисею:
  - "23.10": |
      — Говори с израильтянами и скажи им: «Когда вы войдете в землю, которую Я отдаю вам, и соберете на ней урожай,<span class="notespan"><span class="marginnote note" label="note-44"> Первым собирали ячмень, соответственно первый урожай ячменя приносили во время праздника Пресных хлебов.</span></span> принесите к священнику первый сноп собранного зерна.
  - "23.11": |
  ...
  - "23.13": |
      с хлебным приношением из двух десятых частей ефы<span class="notespan"><span class="marginnote note" label="note-45"> Вероятно, около 4,5 л.; также в ст. 17.</span></span> лучшей муки, смешанной с маслом — это огненная жертва Господу, приятное благоухание — и жертвенным возлиянием из четверти гина<span class="notespan"><span class="marginnote note" label="note-46"> Вероятно, около 1 л.</span></span> вина.
  - "23.14": |
  ...
  - "23.16": |
      Отсчитайте пятьдесят дней до дня, который идет за седьмой субботой, и принесите Господу приношение из нового урожая.<span class="notespan"><span class="marginnote note" label="note-47"> Последней собирали пшеницу, соответственно первый урожай пшеницы приносили во время праздника Жатвы.</span></span>
  - "23.17": |
  ...
  - "23.26": |
      Господь сказал Моисею:
  - "23.27": |
      — В десятый день этого седьмого месяца будет День очищения. Созывайте священное собрание, смиряйте себя<span class="notespan"><span class="marginnote note" label="note-48"> Это включало в себя пост, но не ограничивалось им; также в ст. 29 и 32.</span></span> и приносите Господу огненную жертву.
  - "23.28": |
  ...
  - "23.38": |
      Эти праздники не входят в число Господних суббот, а эти приношения в число<span class="notespan"><span class="marginnote note" label="note-49"> Или: «Эти праздники не входят в число Господних суббот, а эти приношения в число».        </span></span> ваших даров, всех жертв по обету и добровольных приношений, которые вы даете Господу.
  - "23.39": |
  ...
  - "24.3": |
      Пусть Аарон смотрит за светильниками перед Господом вне завесы <em>ковчега</em> свидетельства в шатре собрания с вечера до утра, всегда. Это установление для грядущих поколений будет вечным.
  - "24.4": |
      Лампады на светильнике из чистого<span class="notespan"><span class="marginnote note" label="note-50"> Букв: «на чистом светильнике». См. <span class="link">Исх 25:31</span>.</span></span><em>золота</em> нужно всегда заправлять перед Господом.
  - "24.5": |
      — Возьми лучшую муку и испеки двенадцать хлебов, из двух десятых частей ефы<span class="notespan"><span class="marginnote note" label="note-51"> Вероятно, около 4,5 л.</span></span> каждый.
  - "24.6": |
      Выложи их в два ряда, по шесть в каждый, на стол из чистого<span class="notespan"><span class="marginnote note" label="note-52"> Или: «на чистом столе».        </span></span><em>золота</em> перед Господом.
  - "24.7": |
  ...
  - "24.18": |
      Тот, кто убьет <em>чужую</em> скотину, должен возместить животным за животное.
  - "24.19": |
  ...
  - "25.24": |
      При всякой покупке земли разрешайте выкупать ее обратно.<span class="notespan"><span class="marginnote note" label="note-53"> Или: «Разрешайте выкупать землю во всей стране, которой вы будете владеть».        </span></span>
  - "25.25": |
  ...
  - "26.18": |
      Если и после этого вы не послушаете Меня, Я накажу вас за ваши грехи в семь <em>раз</em> сильнее.
  - "26.19": |
  ...
  - "26.30": |
      Я разрушу ваши <em>святилища на</em> возвышенностях,<span class="notespan"><span class="marginnote note" label="note-54"> Святилища на возвышенностях — евр: «бамот»; также в других местах Ветхого Завета.</span></span> сокрушу кадильные жертвенники и повергну ваши трупы на обломки ваших идолов и возгнушаюсь вами.
  - "26.31": |
  ...
  - "26.34": |
      Тогда земля будет наслаждаться своими субботними годами все время,<span class="notespan"><span class="marginnote note" label="note-55"> Или: «возместит себе за свои субботние года во все время».</span></span> когда будет лежать в запустении, пока вы будете в краю ваших врагов. Тогда земля будет отдыхать и наслаждаться своими субботами.
  - "26.35": |
  ...
  - "26.41": |
      за что и Я ополчился на них и отвел их в землю их врагов, если их необрезанные сердца<span class="notespan"><span class="marginnote note" label="note-56"> Люди с необрезанными сердцами — это метафора, обозначающая людей непокорных Богу.        </span></span> смирятся и они заплатят за свой грех,
  - "26.42": |
  ...
  - "27.3": |
      то оцени мужчину в возрасте между двадцатью и шестьюдесятью годами в пятьдесят шекелей<span class="notespan"><span class="marginnote note" label="note-57"> Около 580 г; также в ст. 16.</span></span> серебра по шекелю святилища.<span class="notespan"><span class="marginnote note" label="note-58"> Около 11,5 г; также в ст. 25.</span></span>
  - "27.4": |
      Если это женщина, оцени ее в тридцать шекелей.<span class="notespan"><span class="marginnote note" label="note-59"> Около 350 г.</span></span>
  - "27.5": |
      Если возраст между пятью и двадцатью годами, оцени мужчину в двадцать шекелей,<span class="notespan"><span class="marginnote note" label="note-60"> Около 230 г.</span></span> а женщину в десять шекелей.<span class="notespan"><span class="marginnote note" label="note-61"> Около 115 г.</span></span>
  - "27.6": |
      Если возраст между месяцем и пятью годами, оцени мальчика в пять шекелей<span class="notespan"><span class="marginnote note" label="note-62"> Около 57 г.</span></span> серебра, а девочку в три шекеля<span class="notespan"><span class="marginnote note" label="note-63"> Около 35 г.</span></span> серебра.
  - "27.7": |
      Если возраст — шестьдесят лет и больше, оцени мужчину в пятнадцать шекелей,<span class="notespan"><span class="marginnote note" label="note-64"> Около 173 г.</span></span> а женщину в десять шекелей.
  - "27.8": |
  ...
  - "27.16": |
      Если человек посвящает Господу участок поля, которое отошло к нему по наследству, его нужно оценить по тому, сколько для него требуется семян — по пятьдесят шекелей серебра за гомер<span class="notespan"><span class="marginnote note" label="note-65"> Вероятно, около 220 л.</span></span> ячменя.
  - "27.17": |
  ...
  - "27.25": |
      Все оценки нужно устанавливать по шекелю святилища, в одном шекеле двадцать гер.<span class="notespan"><span class="marginnote note" label="note-66"> Древнееврейская мера веса, равная примерно половине грамма.</span></span>
  - "27.26": |
      Но пусть никто не посвящает первородных из животных, потому что первенцы и так принадлежат Господу; вол<span class="notespan"><span class="marginnote note" label="note-67"> Это еврейское слово может обозначать как самца, так и самку.</span></span> ли это или баран — они Господни.
  - "27.27": |
  ...
  - "27.28": |
      Но никто не может ни продать, ни выкупить ничего из того, чем он владел и что посвятил Господу по обету,<span class="notespan"><span class="marginnote note" label="note-68"> Все, что таким образом посвящалось Господу, не могло быть более использовано людьми и часто подвергалось полному уничтожению (см. также ст. 29).        </span></span> будь то человек, животное или наследная земля. Все, что было посвящено по обету, — это великая святыня Господа.
  - "27.29": |
